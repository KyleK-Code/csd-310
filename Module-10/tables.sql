...
DROP USER IF EXISTS 'wine_employee'@'localhost';
...
-- -- create the employee hours table (with pay type FK)
-- CREATE TABLE employee_hours(
--     hours_id                INT             NOT NULL        AUTO_INCREMENT,
--     hours_dateStart         DATE,
--     hours_dateEnd           DATE,
...
-- -- Trying to insert multiple fields into distibutor wines held
-- INSERT INTO distributor(distributor_name, distributor_phone, distributor_address, distributor_credentials, wine_id)
--     VALUES('WineBrothers', '402.154.1515', '1231 Monroe Street', (SELECT wine_id FROM wine WHERE wine_name = 'Merlot', SELECT wine_id FROM wine WHERE wine_name = 'Cabernet'));

-- INSERT INTO distributor(distributor_name, distributor_phone, distributor_address, distributor_credentials, wine_id)
--     VALUES('GoldenDistribution', '402.789,5465', '5438 Jefferson Street', (SELECT wine_id FROM wine WHERE wine_name = 'Cabernet', SELECT wine_id FROM wine WHERE wine_name = 'Chablis'));

-- INSERT INTO distributor(distributor_name, distributor_phone, distributor_address, distributor_credentials, wine_id)
--     VALUES('QualityWine', '402.789,5465', '5438 Jefferson Street', (SELECT wine_id FROM wine WHERE wine_name = 'Merlot'));
